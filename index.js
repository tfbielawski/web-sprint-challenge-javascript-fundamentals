...
//Define the function with a,b,cb parameters. Return cb(a,b)
...
//Define the function with parameters a, b. Return a + b
...
/*  🦁🦁🦁 Use greeting to accept a first and last name and 
return "Hello {first-name} {last-name}, nice to meet you!" 🦁🦁🦁 */
  
//Define the function with fn and ln parameters. Return the required string.
...
//Define the volume prototype function. Return l * w * h
...
//Instantiate new object, pass in values
...
{
  //Define the constructor(), Init as object
  ...
  //Define the volume() method. Return l * w * h
  volume(){ return this.length * this.width * this.height; }

  //Define the surfaceArea() method. 
  surfaceArea()
  {
    //Return 2 *((l * w) + (l * h) + (w * h))
    return 2 * ((this.length * this.width) + (this.length * this.height) + (this.width * this.height));
...
//Instantiate object, pass in values
